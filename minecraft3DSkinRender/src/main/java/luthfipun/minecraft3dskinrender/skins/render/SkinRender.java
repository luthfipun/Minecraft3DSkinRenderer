...
public class SkinRender {
    ...
    public static Bitmap createBitmapFromDrawable(Context context, Integer drawableId) {
    ...
    public static Bitmap addBorder(final Bitmap bitmap, final int n) {
        ...
        canvas.drawColor(0);
        canvas.drawBitmap(bitmap, (float) n, (float) n, null);
        return bitmap2;
    }
    ...
    public static Bitmap overlay(final Bitmap bitmap, final Bitmap bitmap2) {
        ...
        canvas.drawBitmap(bitmap2, (float) (bitmap.getWidth() + 20), 0.0f, null);
        return bitmap3;
    }
